$(function() {
	...
	gradient.addColorStop(1, '#f08900');
	new Chart(ctx3, {
		type: 'bar',
		data: {
			labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
	...
	new Chart(ctx4, {
		...
		data: {
			...
			datasets: [{
				label: '# of Votes',
				data: [14, 12, 34, 25, 24, 20],
				backgroundColor: ['#27326B', '#f08900', '#38cb89', '#5b7fff', '#ea2167', '#ef4b4b']
			}]
		},
		options: {
			maintainAspectRatio: false,
	...
	new Chart(ctx5, {
		...
		data: {
			...
			datasets: [{
				data: [14, 12, 34, 25, 24, 20],
				backgroundColor: [ '#f08900', '#38cb89', '#5b7fff', '#ea2167', '#ef4b4b']
			}, {
	...
	gradient1.addColorStop(0, 'rgba(41, 50, 127,0)');
	gradient1.addColorStop(1, 'rgba(41, 50, 127,.5)');
	var gradient2 = ctx3.createLinearGradient(0, 280, 0, 0);
	gradient2.addColorStop(0, 'rgba(240, 137, 0,0)');
	gradient2.addColorStop(1, 'rgba(240, 137, 0,.5)');
	new Chart(ctx9, {
		type: 'line',
		data: {
			labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'July', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
